...
- The build plan lives in `context/feature-specs/00-build-plan.md`.
- Each unit of work has one spec: `context/feature-specs/NN-feature-name.md`.
- Implement exactly what the active spec says. No more, no less.
- Files in `context/feature-specs/_templates/` are templates, not
  work to implement. Never build from a template.
